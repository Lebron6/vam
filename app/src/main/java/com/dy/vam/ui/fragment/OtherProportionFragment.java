...
public class OtherProportionFragment extends BaseFragment {
    ...
    public OtherProportionFragment(SummaryDepartmentData summaryDepartmentData) {
        this.summaryDepartmentData = summaryDepartmentData;
    }

    public OtherProportionFragment() {
    }

    @Override
    protected int attachLayoutRes() {
        return R.layout.fragment_other_depart_proportion;
    }
...
//        }
    ...
    public void showGuideView() {
        ...
        builder1.setTargetView(tvSystemMore)
                ...
                .setOverlayTarget(false) .setHighTargetPadding(10)
    ...
    @OnClick({R.id.tv_system_more, R.id.layout_see_dedails, R.id.layout_departmental_disposable_income, R.id.layout_controllable_cost, R.id.layout_member_management, R.id.tv_system_name, R.id.tv_lunch_more})
