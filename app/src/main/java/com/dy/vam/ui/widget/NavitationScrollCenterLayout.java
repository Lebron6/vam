...
/**
     ...
     */
    public  class NavitationScrollCenterLayout extends RelativeLayout {
        ...
        public NavitationScrollCenterLayout(Context context) {
            this(context, null);
        }
    
        public NavitationScrollCenterLayout(Context context, AttributeSet attrs) {
            this(context, attrs, 0);
        }
    
        public NavitationScrollCenterLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        private void setTitles(Activity context, List<String> titles, final boolean smoothScroll, int splilinecolor, final float splilinewidth, float topoffset, float bottomoffset)
        {
            titleLayout.removeAllViews();
            this.textViews = new TextView[titles.size()];
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(getScreenWidth(context)/titles.size(),LayoutParams.MATCH_PARENT);
