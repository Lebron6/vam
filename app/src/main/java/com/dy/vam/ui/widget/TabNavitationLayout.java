...
public class TabNavitationLayout extends RelativeLayout{
     ...
     */
    public void setViewPager(final Context context, String[] titles, final ViewPager viewPager, int leftdrawable, int middrawable, int rightdrawable, final int txtUnselectecolor, final int txtSelectedcolor, int textsize, int currentPosition, float borderwidth, boolean smoothScroll)
    {
