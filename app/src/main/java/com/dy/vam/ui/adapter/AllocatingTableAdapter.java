...
public class AllocatingTableAdapter extends RecyclerView.Adapter {
    ...
    public AllocatingTableAdapter(Context context, String type) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_allocating_table_content, null);
