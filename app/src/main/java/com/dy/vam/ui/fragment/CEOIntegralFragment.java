...
public class CEOIntegralFragment extends BaseFragment {
    ...
    private int position;       //根据此position 获取部门id  根据部门id 获取部门详情信息
    private String detailsUrl;

    public CEOIntegralFragment(SummaryDepartmentData summaryDepartmentData, int position) {
        this.summaryDepartmentData = summaryDepartmentData;
        this.position = position;
        detailsUrl=summaryDepartmentData.getData().getDetail_url();
    }

    public CEOIntegralFragment() {
    }

    @Override
    protected int attachLayoutRes() {
        return R.layout.fragment_ceo_depart_integral;
    }
...
//                        }
    ...
    @OnClick({R.id.image_question,R.id.btn_task_panel,R.id.layout_see_dedails, R.id.layout_departmental_disposable_income, R.id.layout_controllable_cost, R.id.layout_member_management, R.id.tv_system_name, R.id.tv_lunch_more})
...
//                WebViewActivity.actionStart(getActivity(),"任务面板",summaryDepartmentData.getData().getTasklist_url());
                break;
