 ...
 */
public class DepartOperaDialog extends Dialog  {


    public DepartOperaDialog(Context context) {
        super(context);
    }

    public DepartOperaDialog(Context context, int theme, DialogClickListener dialogClickListener,int position) {
        super(context, theme);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_depart_opera);
        initView();
    }
