...
public class AllocatingTableChildProportionAdapter extends RecyclerView.Adapter {
    ...
    public AllocatingTableChildProportionAdapter(Context context) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.tvContent.setText(customBean.getUsers().get(position).getProportion());
